...
// Regulator PID
float predkoscZadana = 20; // obr/min
float Kp = 2.0;
float Ki = 10;
float Kd = 1;
float integral = 0.0;
...
const float predkoscPoziomy[] = {20, 50, 100, 120};
const unsigned long czasTrwaniaPoziomuPredkosc = 7000; // ms
...
void loop() {
  ...
  if (teraz - czasOstatniegoWyslania >= okresWysylania) {
    ...
    Serial.print("0");
    Serial.print(",");
    Serial.print("Predkosc_zadana:");
    Serial.print(predkoscZadana);
    Serial.print(",");
    Serial.print("Predkosc_aktualna:");
    Serial.print(predkosc);
    Serial.print(",");
    Serial.print("Aktualny_Error:");
    Serial.print(aktualnyError);
    Serial.print(",");
    Serial.print("Wyjscie_Pwm:");
